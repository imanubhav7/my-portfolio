      ...
      <div className="h-full w-full bg-black rounded-[50px] relative shadow-xl shadow-gray-700 overflow-hidden ">
        {/* Project1 Div  */}
          ...
          <div className="pl-4 flex flex-col">
            <h1 className=" text-[24vh] font-[Fb4] uppercase">
              CloudVault
            </h1>
            <p className="absolute bottom-12 text-[1.4em] font-[Fb2] text-gray-500">
             Cloud-based storage management system
            </p>
          </div>
          ...
          <div className="flex w-[26vw] flex-col justify-start items-start mt-16 mr-24 ">
            <p className="font-[Fb3] text-[1.6em]">
              Built with: Next.js, Appwrite, Tailwind CSS, JWT
            </p>
            <div className="flex gap-5 justify-center items-center mt-5">
              <span className=" font-[Fb2] text-[1.4em]">View the code</span>
              <NavLink to="https://github.com/imanubhav7/CloudVault">
                <FontAwesomeIcon
                  className="text-[1.6em] cursor-pointer"
                  icon={faGithub}
                />
              </NavLink>
            </div>
        ...
        <div className="flex ml-4 mr-4 relative flex-wrap borderBtm justify-between mt-[4em] px-[3em] ">
          ...
          <div className="flex w-[26vw] flex-col justify-start items-start mt-16 mr-24 ">
            <p className="font-[Fb3] text-[1.6em]">
              Built with: NextJS, Tailwind CSS, OpenAI GPT API, Clerk,Node.js,
              Prisma.
            </p>
            <div className="flex gap-5 justify-center items-center mt-5">
              <span className=" font-[Fb2] text-[1.4em]">View the code</span>
              <NavLink to="https://github.com/imanubhav7/CoachAI">
                <FontAwesomeIcon
                  className="text-[1.6em] cursor-pointer"
                  icon={faGithub}
                />
        ...
        {/* <div className="flex ml-4 mr-4 relative flex-wrap borderBtm justify-between mt-[4em] px-[3em] ">
          <div className="pl-4 flex flex-col">
            ...
            <p className="absolute bottom-12 text-[1.4em] font-[Fb2] text-gray-500">
              Location-Based Healthcare Search Tool{" "}
            </p>
          </div> */}
          ...
          {/* <div className="flex w-[26vw] flex-col justify-start items-start mt-16 mr-24 ">
            ...
            <div className="flex gap-5 justify-center items-center mt-5">
              <span className=" font-[Fb2] text-[1.4em]">View the code</span>
              <NavLink to="https://github.com/imanubhav7">
                <FontAwesomeIcon
                  className="text-[1.6em] cursor-pointer"
                  icon={faGithub}
                />
